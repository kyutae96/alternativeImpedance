/// BLE Service - Mobile Implementation (Android/iOS)
...
BleServiceInterface createBleService() => BleServiceMobile();

class BleServiceMobile extends BleServiceInterface {
  ...
  @override
  String get platformName => 'Mobile (Android/iOS)';
